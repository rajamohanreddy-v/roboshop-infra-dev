...
yum-config-manager --add-repo https://github.com/Rajamohanreddy-vaka/roboshop-infra-dev.git
yum -y install terraform

# creating databases
cd /home/ec2-user
git clone https://github.com/Rajamohanreddy-vaka/roboshop-infra-dev.git
